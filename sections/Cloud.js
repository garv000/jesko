...
const Cloud = () => {
  useGSAP(() => {
    const aboutText = new SplitText(".about-text", { type: "chars" });
  ...
  return (
    <div
      id="about"
      className="relative w-screen h-[150vh] text-white px-28 bg-blue-400"
    >
      <div className="w-full h-full flex flex-col gap-30">
        <p className="about-text text-6xl font-extrabold tracking-tight leading-tight z-10">
          Jesko Jets® is a private aviation operator with over 5,000 missions
          completed across 150+ countries. From international executives to
          global industries, our clients trust us to deliver on time, every
          time.
        </p>

        <div className="about-text2 flex items-start z-10">
          ...
          <div className="flex flex-col gap-12">
            <div className="flex gap-18">
              <div className="flex flex-col gap-6">
                <p className="text-3xl font-bold max-w-xs tracking-tight">
                  Direct Access to Private Travel
                </p>
                <div className="w-8 h-0.5 bg-white"></div>
                <p className="font-semibold tracking-tight max-w-xs text-xs">
                  Fly beyond boundaries with Jesko Jets. Our global operations
                  ensure seamless, personalized travel experiences — from the
                  first call to landing. Every journey is tailored to your
                  comfort, privacy, and schedule.
                </p>
              </div>
              <div className="flex flex-col gap-6">
                <p className="text-3xl font-bold max-w-xs tracking-tight">
                ...
                <div className="w-8 h-0.5 bg-white"></div>
                <p className="font-semibold tracking-tight max-w-xs text-xs">
                  We value your time above all. Jesko Jets gives you the freedom
                  to live, work, and relax wherever life takes you — without
                  compromise.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-16">
              <div className="flex flex-col gap-6">
                ...
                <div className="w-8 h-0.5 bg-white"></div>
                <p className="font-semibold tracking-tight max-w-xs text-xs">
                  Each detail of your flight — from route planning to in-flight
                  service — reflects our dedication to perfection. Our crew and
                  fleet meet the highest global standards, ensuring reliability
                  in every mission.
                </p>
              </div>
              <div className="flex flex-col gap-6">
                ...
                <div className="w-8 h-0.5 bg-white"></div>
                <p className="font-semibold tracking-tight max-w-xs text-xs">
                  With access to destinations in over 150 countries, Jesko Jets
                  brings the world closer to you. Our experts manage every
                  aspect of your flight, guaranteeing a smooth and effortless
                  journey.
                </p>
              </div>
            </div>
      ...
      <div
        className="absolute top-0 left-0 w-full h-50 
              bg-linear-to-t from-transparent to-blue-200 pointer-events-none"
      ></div>
      <div
        className="absolute bottom-0 left-0 w-full h-100 
              bg-linear-to-b from-transparent to-[#FFF8ED] pointer-events-none"
      ></div>
    </div>
  );
};
